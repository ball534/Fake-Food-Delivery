    ...
    >
      ...
      <div className="p-3">
        <div className="flex items-start justify-between gap-2">
          <h3 className="font-bold text-neutral-900 dark:text-white">{store.name}</h3>
          <span className="flex items-center gap-0.5 text-sm font-semibold text-neutral-700 dark:text-neutral-200">
